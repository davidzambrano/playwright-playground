...
class SlowResourcesPage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.mid_resource_banner_locator = "//div[@role='alert' and contains(., 'Large Javascript bundle (15s) has finished loading.')]"
        self.large_resource_banner_locator = "//div[@role='alert' and contains(., 'High-resolution image (30s) has finished loading.')]"
