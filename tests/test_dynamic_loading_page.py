...
@allure.epic("Dynamic Loading Interactions")
@pytest.mark.ui
...
class TestDynamicLoadingPage:
    ...
    @allure.story("Dynamic Loading behaviour")
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example1 content is hidden initially")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example1 content becomes visible after start")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example1 content text is correct")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example2 content not present initially")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example2 content appears after start")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Dynamic Loading behaviour")
    @allure.title("Example2 content text is hello world")
    @allure.severity(allure.severity_level.NORMAL)
