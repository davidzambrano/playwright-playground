...
@allure.epic("Multiple Windows Interactions")
@pytest.mark.ui
...
class TestMultipleWindowsPage:
    ...
    @allure.story("Multiple Windows behaviour")
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("Click here opens new window")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("New window heading is correct")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("New window content is visible")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("Original page still active after closing new window")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("New window url is correct")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("New window description is visible")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("New window back to home link is visible")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("Original page url unchanged after opening new window")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Multiple Windows behaviour")
    @allure.title("Multiple new windows can be opened")
    @allure.severity(allure.severity_level.NORMAL)
